...
app.controller('cotizadorCtrl', function($scope, $rootScope, $http, $mdDialog, mdDialog, alertas, $mdExpansionPanel, $mdExpansionPanelGroup, $timeout, $mdSidenav, $state, $stateParams, Categoria, Template, Buscador, Imagen) {
	...
	self.buscador = {
		...
		recibo: function(valor, id, cantidad, idConcepto){
			$scope.id = id;
